...
export function StethoscopeIcon({ size = 16, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M4.8 2.3A.3.3 0 0 0 4.5 2.6V8A5.5 5.5 0 0 0 10 13.5A5.5 5.5 0 0 0 15.5 8V2.6a.3.3 0 0 0-.3-.3H13a.3.3 0 0 0-.3.3V8a2.8 2.8 0 0 1-5.6 0V2.6A.3.3 0 0 0 6.8 2.3H4.8z" />
      <path d="M10 13.5V17a3 3 0 0 0 3 3h4.5a2.5 2.5 0 0 0 2.5-2.5v-.5" />
...
export function RocketIcon({ size = 16, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M15 8s-2-3-6-3c-3 0-5 2-5 5 0 4 3 6 3 6l9-8z" />
      <path d="M12 15l-3-3" />
...
export function TagIcon({ size = 16, className, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 2H2v10l11.29 11.29c.39.39 1.02.39 1.41 0l7.59-7.59c.39-.39.39-1.02 0-1.41L12 2z" />
...
export function RulerIcon({ size = 16, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
