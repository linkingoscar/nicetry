...
describe('CapabilityList', () => {
  const mockCapabilities: AdvancedAnalysisCapability[] = [
    ...
    },
    {
      ...
      plannedEngine: 'R',
      minimumValidation: [],
      slices: [{ id: 'longitudinal_model.ri_clpm', label: 'RI-CLPM', status: 'planned', executionAvailable: false, supportBoundary: 'test' }]
    }
  ]
  ...
  it('renders capabilities, filtering out non-executable ones', async () => {
    ...
    expect(screen.queryByText('纵向模型')).not.toBeInTheDocument()
  })
