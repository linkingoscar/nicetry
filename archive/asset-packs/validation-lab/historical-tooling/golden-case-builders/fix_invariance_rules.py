...
cases = ["invariance_two_group_continuous", "invariance_three_group_partial", "invariance_unbalanced_groups_boundary"]
...
print("Comparison rules for measurement.invariance.multi_group.v1 generated!")
