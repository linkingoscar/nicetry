...
cases = ["contrast_balanced_one_way", "contrast_ancova_nonorthogonal", "contrast_zero_weights_boundary"]
...
print("Comparison rules for experiment.emmeans.planned_contrast.v1 generated!")
