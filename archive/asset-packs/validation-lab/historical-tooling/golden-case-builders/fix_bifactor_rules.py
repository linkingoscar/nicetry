...
cases = ["bifactor_continuous_typical", "bifactor_continuous_three_specific", "bifactor_continuous_dominant_general_boundary"]
...
print("Comparison rules for measurement.bifactor.continuous.v1 generated!")
