...
cases = ["mediation_balanced_typical", "mediation_unbalanced_complex", "mediation_zero_indirect_boundary"]
...
print("Comparison rules for multilevel.mediation.two_level.v1 generated!")
