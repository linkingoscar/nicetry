...
cases = ["cfa_continuous_mlr_typical", "cfa_continuous_mlr_three_factor_fiml", "cfa_continuous_mlr_collinear_boundary"]
...
print("Comparison rules for measurement.cfa.continuous.mlr.v1 generated!")
