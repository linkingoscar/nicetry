...
cases = ["lmm_group_mean_centering", "lmm_within_between_unbalanced", "lmm_within_between_zero_within_var"]
...
print("Comparison rules for multilevel.lmm.within_between.v1 generated!")
