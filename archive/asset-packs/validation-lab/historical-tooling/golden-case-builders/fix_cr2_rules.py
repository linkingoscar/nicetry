...
cases = ["cr2_small_sample_typical", "cr2_unbalanced_clusters_complex", "cr2_few_clusters_boundary"]
...
print("Comparison rules for multilevel.se.cluster_robust.v1 generated!")
