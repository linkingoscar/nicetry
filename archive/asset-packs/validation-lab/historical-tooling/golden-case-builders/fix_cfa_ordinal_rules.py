...
cases = ["cfa_ordinal_wlsmv_typical", "cfa_ordinal_wlsmv_skewed_binary", "cfa_ordinal_wlsmv_extreme_category_boundary"]
...
print("Comparison rules for measurement.cfa.ordinal.wlsmv.v1 generated!")
