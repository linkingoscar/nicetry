...
cases = ["repeated_balanced_one_within", "repeated_sphericity_violation", "repeated_near_perfect_correlation_boundary"]
...
print("Comparison rules for experiment.repeated.one_within.v1 generated!")
