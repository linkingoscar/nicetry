...
cases = ["esm_diary_ar1_typical", "esm_diary_ar1_missing_prompts", "esm_diary_ar1_zero_phi_boundary"]
...
print("Comparison rules for longitudinal.esm.diary_ar1.v1 generated!")
