...
cases = ["lmm_random_slope_typical", "lmm_random_slope_unbalanced", "lmm_singular_covariance_boundary"]
...
print("Comparison rules for multilevel.lmm.two_level.gaussian.random_slope.v1 generated!")
