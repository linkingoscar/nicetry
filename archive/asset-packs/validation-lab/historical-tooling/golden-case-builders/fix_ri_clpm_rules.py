...
cases = ["ri_clpm_four_wave_typical", "ri_clpm_four_wave_unbalanced_missing", "ri_clpm_four_wave_zero_ri_var_boundary"]
...
print("Comparison rules for longitudinal.ri_clpm.four_wave.v1 generated!")
