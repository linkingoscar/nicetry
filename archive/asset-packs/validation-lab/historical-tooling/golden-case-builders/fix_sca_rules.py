...
cases = ["sca_multiverse_typical", "sca_high_dimensional_complex", "sca_single_spec_boundary"]
...
print("Comparison rules for robustness.specification_curve.matrix.v1 generated!")
